...
contextBridge.exposeInMainWorld('rokuPanel', {
  ...
  getFolderSettings: () => ipcRenderer.invoke('settings:getFolders'),
  pickDirectory: (currentPath) => ipcRenderer.invoke('settings:pickDirectory', currentPath),
  revealFolder: (dirPath) => ipcRenderer.invoke('settings:revealFolder', dirPath),
